...
The PUD switch isolates all \inquotes{pull up} resistors of the ATmega. The output of a pin can be switched off
...
with the meassage \inquotes{Cell!}. This can also be happen, if no capacitor is connected to any test pin.
