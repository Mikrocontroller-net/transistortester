...
Daneben hat dat Programm avrdude die Möglichkeit, die Aktivitäten zu protokollieren.
Eingeschaltet wird diese Funktion mit der Option -v .
Durch mehrere v wird das Protokoll ausführlicher. Mit -vvvv wird
nahezu jedes Detail protokolliert.
