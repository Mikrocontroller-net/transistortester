...
\centering
 \begin{overpic}[width=17cm]{../FIG/PNPcc.pdf}
  \color{black}
  \put(55,20){\makebox(0,0)[lb]{Wenn Spannung an PC1 \textless~10mV ist,}}
  \put(55,17){\makebox(0,0)[lb]{wird der \textcolor{green}{grün} gezeichnete Zustand benutzt!}}
 \end{overpic}
...
\centering
 \begin{overpic}[width=17cm]{../FIG/PNPce.pdf}
  \color{black}
  \put(55,21){\makebox(0,0)[lb]{Schwarzer Zustand wird benutzt beim Test!}}
  \put(55,17){\makebox(0,0)[lb]{\textcolor{green}{Grüner} Zustand wird für den}}
  \put(55,13){\makebox(0,0)[lb]{Stromverstärkungsfaktor hFE benutzt.}}
 \end{overpic}
...
\centering
 \begin{overpic}[width=17cm]{../FIG/NPNce.pdf}
  \color{black}
  \put(55,23){\makebox(0,0)[lb]{Schwarzer Zustand wird benutzt beim Test!}}
  \put(55,19){\makebox(0,0)[lb]{\textcolor{green}{Grüner} Zustand wird für den}}
  \put(55,15){\makebox(0,0)[lb]{Stromverstärkungsfaktor hFE benutzt.}}
 \end{overpic}
