...
Die Meldung ,,\mbox{\begin{large}1 \electricC 3~\textgreater 100nF\end{large}}'' wird in Zeile 1 des Displays angezeigt.
...
sollte an Pin~1 und Pin~3 angeschlossen werden, wenn die Meldung ,,\mbox{\begin{large}1 \electricC 3~10-30nF(L)\end{large}}'' in Zeile 1 des
...
\begin{figure}[H]
  \centering
  \includegraphics[width=16cm]{../GNU/SelfTrefGE.pdf}
...
\begin{figure}[H]
  \begin{subfigure}[b]{9cm}
    \centering
    \includegraphics[width=9cm]{../GNU/SelfTMitLGE.pdf}
  ...
  \begin{subfigure}[b]{9cm}
    \centering
    \includegraphics[width=9cm]{../GNU/SelfTMitHGE.pdf}
...
\begin{figure}[H]
  \begin{subfigure}[b]{9cm}
  \centering
    \includegraphics[width=9cm]{../GNU/SelfTbottomHGE.pdf}
  ...
  \begin{subfigure}[b]{9cm}
  \centering
    \includegraphics[width=9cm]{../GNU/SelfTtopHGE.pdf}
...
\begin{figure}[H]
  \begin{subfigure}[b]{9cm}
  \centering
    \includegraphics[width=9cm]{../GNU/SelfTRiLoGE.pdf}
  ...
  \begin{subfigure}[b]{9cm}
  \centering
    \includegraphics[width=9cm]{../GNU/SelfTRiHiGE.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=16cm]{../GNU/SelfTcap0GE.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=16cm]{../GNU/SelfTrefKorrGE.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=16cm]{../GNU/SelfTrefDiffGE.pdf}
