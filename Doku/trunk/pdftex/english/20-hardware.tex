...
\begin{figure}[H]
  \begin{subfigure}[b]{9cm}
    ...
    \color{black}
    \put(78,36){\makebox(0,0)[lb]{\footnotesize VCC or U{\scriptsize Bat}}}
...
{\bf The tester is operated with a button that is both a button and an encoder.}
It offers all of the extensions to measure crystals and zener diodes.
...
{\bf left to right}: 1~-Reset; 2~-SCK; 3~-MISO; 4~-MOSI; 5~-+5V; 6~-GND.\\
...
\begin{figure}[H]
 \centering
 \begin{overpic}[width=12cm]{../FIG/Kabel_Hiland.pdf}
  \color{black}
...
{\bf The test ports TP1, TP2 and TP3} are used for automatic component recognition
and are on the board with the the number sequence {\bf 1,1,1; 2; 3,3,3}.

The same numbers can be found on the SMD test field 
and at three holes to solder your own test cable.\\


The {\bf Testport TP2} is also used for the output of the special function ,,f-Generator''.\\
The pins labeled {\bf LF} are intended for the measurement of quartz crystals with a low resonance frequency,
\\und die mit {\bf HF} are intended for crystals with a high resonance frequency.

The pin {\bf F-in} is used together with {\bf Gnd} for the function frequency measurement.\\
And the pin {\bf Vext+} is used with {\bf Gnd} for the voltage measurement
{\bf and} is also used for the Zener diode measurement.\\
