...
\begin{figure}[H]
\centering
\includegraphics[width=7cm]{../FIG/Frequency_addon.pdf}
...
\begin{figure}[H]
 \centering
 \begin{overpic}[width=5cm]{../FIG/rotary_extension.pdf}
  \color{black}
...
\begin{figure}[H]
 \centering
 \begin{overpic}[width=15cm]{../FIG/rotary_encoder.pdf}
  \color{black}
...
\begin{figure}[H]
 \centering
 \begin{overpic}[width=17cm]{../FIG/rotary_bouncing.pdf}
  \color{black}
...
\begin{figure}[H]
 \centering
 \begin{overpic}[width=14cm]{../FIG/ST7565lcd.pdf}
  \color{black}
...
\begin{figure}[H]
  \begin{subfigure}[b]{9cm}
    \centering
    \includegraphics[width=8cm]{../FIG/ST7108serial164.pdf}
    \caption{mit 74HCT164}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{9cm}
    \centering
    \includegraphics[width=8cm]{../FIG/ST7108serial595.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=18cm]{../FIG/t1280tester.pdf}
...
{\bf Bedient wird der Tester mit einem Knopf, der sowohl Taster als auch Drehgeber ist.}
...
\\- Impulsdrehgeber
\\- die Quarz-Messung
\\- Spannung und Zehnerdioden Bestimmung (bis fast 50V).
...
{\bf von links nach rechts}: 1~-Reset; 2~-SCK; 3~-MISO; 4~-MOSI; 5~-+5V; 6~-GND.\\
...
\begin{figure}[H]
 \centering
 \begin{overpic}[width=11cm]{../FIG/Kabel_Hiland.pdf}
  \color{black}
...
\begin{figure}[H]
  \begin{subfigure}[b]{8cm}
    \centering
    \includegraphics[width=7cm]{../PNG/Hi_u.jpg}
    \caption{unten TP1 bis TP3 für Bauteilebestimmung}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{9cm}
    \centering
    \includegraphics[width=6.8cm]{../PNG/Hi_o.jpg}
...
{\bf Die Testports TP1, TP2 und TP3} werden für die automatische Bauteilerkennung benutzt
und sind auf der Platine mit den Ziffern {\bf 1,1,1; 2; 3,3,3} gekennzeichnet.
...
Der {\bf Testport TP2} wird auch für die Ausgabe der Sonderfunktion ,,f-Generator'' benutzt.\\
Die mit {\bf LF} bezeichneten Pins sind für die Messung von Quarzen mit niedriger Resonanzfrequenz vorgesehen,
und die mit {\bf HF} bezeichneten Pins sind für Quarze mit hoher Resonanzfrequenz bestimmt.

Der Pin {\bf F-in} wird zusammen mit  {\bf Gnd} für die Sonderfunktion Frequenz benutzt.
Und der Pin {\bf Vext+} wird genauso mit {\bf Gnd} für die Spannungsmessung
{\bf und} die Zenerdiodenmessung benutzt.\\
