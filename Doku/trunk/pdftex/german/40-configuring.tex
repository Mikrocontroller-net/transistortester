...
Mit dem Befehl:
\newline\large{\verb"git clone https://github.com/Mikrocontroller-net/transistortester"\newline}
...
dem Kommando \mbox{\verb"ls -lh"}. Hier wurden jetzt zwei Optionen für das Kommando ls zusammengefasst,
...
Standard installiert, was sie aber mit \verb"sudo apt install tree" leicht nachholen können.\\
...
\verb"(cd ~/transistortester ; git pull)"
...
\verb"rsync -auv ~/transistortester/Software/trunk ~/Mytester" 
ausführt.
...
möglich. Das Programm muß aber wahrscheinlich mit \mbox{\verb"sudo apt get kdiff3"}
