...
Diesen Nullwert habe ich mit der Boardversion ,,DG2BRS V 5.2.1'' ermittelt.
...
Die Punkte ,,diff2ref'' zeigen die Spannungsdifferenz, die sich nach dem Laden
...
Die Punkte ,,CapErr'' zeigen die aus den Abbildungen \ref{fig:mega168all},
...
Deshalb zeigen die Punkte ,,diff'' die Differenz zwischen den jeweiligen ,,CapErr'' und
,,diff2ref'' Punkten.
Für die Korrektur der Kondensatormessung kann also die Differenz der
Kondensator-Ladespannung zur internen Referenzspannung (,,diff2ref'') benutzt werden.
Dabei kann zusätzlich der mittlere Wert der Differenzen zu den ,,CapErr'' Schätzungen
(,,diff'') berücksichtigt werden.
...
Option ,,PARTNO = '' musste wegen dem avrdude-Programm an den unterschiedlichen
Prozessortyp (,,m168'', ,,m168p'', ,,m328'' oder ,,m328p'') angepasst werden. 
