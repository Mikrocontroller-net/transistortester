...
Die Abbildung~\ref{fig:CapEquiv} zeigt ein Ersatzschaltbild eines Kondensators.
...
\vspace{-\baselineskip}
\begin{center}
\includegraphics[width=0.30\textwidth]{../FIG/Cap_equiv.pdf}
\vspace{-0.5\baselineskip}
\caption {Kondensator-Ersatzschaltbild}
%[labelsep=newline]
\vspace{-0.5\baselineskip}
\label{fig:CapEquiv}
\end{center}
...
angegebenen ESR-Werte für die Elektrolytkondensatoren verschiedener Betriebs-Spannungen für die FC- und die \inquotes{low ESR} FR-Reihe.
...
\begin{figure}[H]
  \centering
   \includegraphics[width=.8\textwidth]{../GNU/Cap_FC_dataGE.pdf}
...
\begin{figure}[H]
  \centering
   \includegraphics[width=.8\textwidth]{../GNU/Cap_FR_dataGE.pdf}
...
\begin{figure}[H]
  \centering
   \includegraphics[width=.8\textwidth]{../GNU/Cap_FC_FR_dataGE.pdf}
...
\begin{figure}[H]
\centering
 \includegraphics[width=.93\textwidth]{../GNU/CesrGE.pdf}
...
\begin{figure}[H]
\centering
 \includegraphics[width=.93\textwidth]{../GNU/Cesr2GE.pdf}
...
\begin{figure}[H]
\centering
 \includegraphics[width=.93\textwidth]{../GNU/Elco_esrGE.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.\textwidth]{../GNU/res_esrGE.pdf}
...
\begin{figure}[H]
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Cesr_22nGE.pdf}
    \caption{höhere ESR Werte}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Cesr_22n_lowGE.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=.93\textwidth]{../GNU/Mega8capGE.pdf}
...
\begin{figure}[H]
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega8AcapGE.pdf}
  ...
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega8LcapGE.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.\textwidth]{../GNU/Mega168capGE.pdf}
...
Als Bezugswert wurde hier eine beste Schätzung genommen. Die Kurve \inquotes{Multimeter} zeigt die Abweichungen, die mit einem
Peaktech~3315 Multimeter gemessen wurden.
Die nächste Kurve \inquotes{LCR} zeigt die Abweichungen, die mit einem Peaktech~2170 LCR-Meter in dem jeweils günstigsten Frequenzbereich gemessen wurden.
Zum Vergleich werden mit der Kurve \inquotes{ATmega168as} auch noch die Messabweichungen eines ATmega168 bestücktem Transistor-Testers gezeigt.
...
\begin{figure}[H]
\centering
\includegraphics[width=1.\textwidth]{../GNU/capcompareGE.pdf}
...
nicht benutzt. Dieser Nullwert beinhaltet schon die \(2-3pF\), die durch die etwa \(12cm\) langen
Anschlussleitungen mit den Klemmen verursacht werden.
Auch das Board-Layout hat Einfluss auf diesen Nullwert.
Diesen Nullwert habe ich mit der Boardversion \inquotes{DG2BRS V 5.2.1} ermittelt.

\begin{figure}[H]
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega168allGE.pdf}
  ...
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega168AallGE.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=.93\textwidth]{../GNU/Mega168PAallGE.pdf}
...
\begin{figure}[H]
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega328allGE.pdf}
  ...
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega328PallGE.pdf}
...
Bei einem automatischen Abgleich ist REF\_C\_KORR  nur ein Offset zu der gemessenen
Differenzspannung von geladenem Kondensator und der internen Referenz.
...
Die Abbildung~\ref{fig:mega168optcap} zeigt die Messabweichung bei Kondensatormessung nur
mit der Berücksichtigung des Nullwertes (168-3-A), mit dem Korrekturfaktor für kleine
Kondensatoren REF\_C\_KORR=66 sowie dem Korrekturfaktor für große Kondensatoren C\_H\_KORR=5 (168-3-B),
sowie zusätzlich als Kurve 168-3-C  mit der Berücksichtigung einer Span\-nungs\-an\-stiegs\-kom\-po\-nen\-te 
...
\begin{figure}[H]
\centering
\includegraphics[width=.93\textwidth]{../GNU/Mega168cap_optGE.pdf}
...
Der automatische Abgleich besteht aus zwei Teilen.
Der erste Teil besteht darin, einen Nullabgleich der Kondensatormessung durchzuführen.
Dazu wird in der Selbsttest-Routine der Mittelwert der gemessenen Kapazität
bei nicht angeschlossenem Kondensator bestimmt.
Es werden die Mittelwerte aus jeweils 8 Messungen für alle 6 Messkombinationen bestimmt.
Nach erfolgreichem Abgleich werden die Korrekturwerte im EEPROM festgehalten
und für künftige Messungen verwendet.
Schwieriger ist die Beseitigung der Exemplarstreuungen bei der Messung von Kondensatoren
bis etwa \(40\mu F\), wie sie in den 
Abbildungen \ref{fig:mega168all}, \ref{fig:mega168Aall} und \ref{fig:mega168PAall} gezeigt wurden.
Als wesentliche Ursache wurde das unterschiedliche Verhalten (Offset-Spannung)
des analogen Komparators herausgefunden.

In Abbildung \ref{fig:CompAdjust} werden die Daten von den neun untersuchten Prozessoren gezeigt.
Die Punkte \inquotes{diff2ref} zeigen die Spannungsdifferenz, die sich nach dem Laden
eines Kondensators mit \(660nF\) zu der jeweiligen internen Referenzspannung ergibt.
Idealerweise wäre diese Spannung immer Null, wenn der analoge
Komparator rechtzeitig das Signal zum Beenden des Ladevorganges gegeben hätte.s
Die kurze Verwaltungszeit des ATmega sollte bei der relativ großen Kapazität zu
keiner messbaren Spannungserhöhung geführt haben.
Die Punkte \inquotes{CapErr} zeigen die aus den Abbildungen \ref{fig:mega168all},
\ref{fig:mega168Aall} und \ref{fig:mega168PAall} 
geschätzten Messfehler der einzelnen ATmega-Exemplare in Promille.
Auffällig ist, wie die \inquotes{CapErr} Punkte den \inquotes{diff2ref} Punkten folgen.
Deshalb zeigen die Punkte \inquotes{diff} die Differenz zwischen den jeweiligen \inquotes{CapErr} und
\inquotes{diff2ref} Punkten.
Für die Korrektur der Kondensatormessung kann also die Differenz der
Kondensator-Ladespannung zur internen Referenzspannung (\inquotes{diff2ref}) benutzt werden.
Dabei kann zusätzlich der mittlere Wert der Differenzen zu den \inquotes{CapErr} Schätzungen
(\inquotes{diff}) berücksichtigt werden.
...
\begin{figure}[H]
\centering
\includegraphics[width=.8\textwidth]{../GNU/ComparatorAdjustGE.pdf}
...
Die Prozessoren wurden alle mit der selben Software programmiert, lediglich die Makefile
Option \inquotes{PARTNO = } musste wegen dem avrdude-Programm an den unterschiedlichen
Prozessortyp (\inquotes{m168}, \inquotes{m168p}, \inquotes{m328} oder \inquotes{m328p}) angepasst werden. 
...
\begin{figure}[H]
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega168calGE.pdf}
    \caption{drei ATmega168}
  ...
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega168AcalGE.pdf}
    \caption{drei ATmega168A}
...
\begin{figure}[H]
\centering
\includegraphics[width=.93\textwidth]{../GNU/Mega168PAcalGE.pdf}
...
\begin{figure}[H]
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega328calGE.pdf}
    \caption{drei ATmega328}
  ...
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=1.\textwidth]{../GNU/Mega328PcalGE.pdf}
    \caption{drei ATmega328P}
...
Die Punkte mit der Endung \inquotes{unc} zeigen die Messabweichungen ohne Kalibration.
Die Linien mit der Endung \inquotes{cal} zeigen die Messabweichungen der gleichen Prozessoren
...
\begin{figure}[H]
\centering
\includegraphics[width=.93\textwidth]{../GNU/MegaAutoGE.pdf}
...
einem externen \(220nF\) Folien-Kondensator abgeglichen, im Vergleich zu den Ergebnissen
eines ATmega328 auf einer anderen Platine.

\begin{figure}[H]
\centering
\includegraphics[width=.93\textwidth]{../GNU/Mega1284GE.pdf}
