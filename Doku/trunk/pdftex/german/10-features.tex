...
Der Betriebsmodus wird durch \textbf{[R]} oder \textbf{[RL]} auf der rechten Seite von Zeile 1 des Displays angezeigt.
Genau so wechselt der Tester zu einem Kapazitätsmeßgerät, wenn bei der Bauteile-Untersuchung
eine Kondensator an TP1 und TP3 erkannt wurde. Dieser Betriebsmodus wird durch \textbf{[C]} auf der rechten Seite der Zeile 1 angezeigt.
...
\vspace{1cm}
\textbf{\Large {Achtung:}} Stellen Sie immer sicher, dass \textbf {Kondensatoren} vor dem Anschluss an den Tester \textbf {entladen} sind!
...
dass {\textbf keine Restspannung} im Gerät vorhanden ist.
