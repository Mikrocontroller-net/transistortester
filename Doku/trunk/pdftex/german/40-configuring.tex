...
\begin{figure}[H]
  \begin{subfigure}[b]{8,5cm}
    \centering
    \includegraphics[width=8cm]{../PNG/Notepad_open.png}
    \caption{open Makefile}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{8,5cm}
    \centering
    \includegraphics[width=8cm]{../PNG/Notepad_save.png}
...
\begin{figure}[H]
  \begin{subfigure}[b]{8,5cm}
    \centering
    \includegraphics[width=8cm]{../PNG/Notepad_make.png}
    \caption{Erzeuge Programmdaten (.hex/.eep)}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{8,5cm}
    \centering
    \includegraphics[width=8cm]{../PNG/Notepad_program.png}
