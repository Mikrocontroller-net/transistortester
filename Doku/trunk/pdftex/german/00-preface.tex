...
\\damit auch Linux \inquotes{Neulinge} einen Erfolg erfahren.
\vspace*{0.3cm}
...
\\- Da ich der Meinung bin, das die Ergänzungen für \inquotes{Linux Anfänger} wichtig sind, hat diese Ausgabe seine Berechtigung.
\vspace*{0.3cm}
...
Programms und Änderung aller \inquotes{if}-Abfragen im Programm, wo Spannungswerte geprüft wurden.
