...
be checked by typing \verb"ls" ( \mbox{\keys{L} \keys{S} \keys{\return}} ).
...
You can also view the files in \verb"~/Mytester/trunk/" with the Files window \menu[,]{Menu,Accessories, Files}, the directory \verb"Mytester" and then
